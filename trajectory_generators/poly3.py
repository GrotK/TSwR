...
class Poly3(TrajectoryGenerator):
    def __init__(self, start_q, desired_q, T):
        ...
        """
        self.a_0 = self.q_0
        self.a_1 = 3 * self.q_0 # a1 = 3 * a_0
        self.a_2 = 3 * self.q_k # a_2 = 3 * a_3
        self.a_3 = self.q_k
        # self.a_0 = self.q_0
        # self.a_1 = -3 * self.q_0
        # self.a_2 = 3 * self.q_k - 6*self.q_0
        # self.a_3 = self.q_k
    def generate(self, t):
        """
        ...
        q_dot = 3 * self.a_3 * t ** 2 + 2 * self.a_2 * t - 3 * self.a_2 * t **2 - 4 * self.a_1 * t + 3 * self.a_1 * t ** 2 - 3 * self.a_0 + 6 * self.a_0 * t - 3 * self.a_0 * t ** 2 + self.a_1
